  ...
  include_once 'sumar.php'; // incluye al ruteo el archivo sumar.php
  include_once 'about.php'; // incluye al ruteo el archivo about.php
  include_once 'pi.php'; // incluye al ruteo el archivo pi.php
  ...
  // llama a la funcion parse con la url
